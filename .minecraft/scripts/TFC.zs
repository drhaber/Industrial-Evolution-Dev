...
mods.terrafirmacraft.ItemRegistry.registerFuel(<minecraft:coal_block>, 19800, 1415, true, true);
...
mods.terrafirmacraft.Heating.addRecipe("destroy_red", <tfc:metal/bucket/red_steel>, <tfc:metal/scrap/copper>, 700, 1300);
...
#mods.terrafirmacraft.ItemRegistry.registerItemMetal(<tfc:metal/bucket/red_steel>, "MITHRIL", 200, true);
