...
<ore:foodRawpork>.addItems([<minecraft:porkchop>,<tfc:food/pork>]);
<ore:foodCookedpork>.addItems([<minecraft:cooked_porkchop>,<tfc:food/cooked_pork>]);
...
<ore:foodRawchicken>.addItems([<minecraft:chicken>,<tfc:food/chicken>]);
<ore:foodCookedchicken>.addItems([<minecraft:cooked_chicken>,<tfc:food/cooked_chicken>]);
<ore:foodRawbeef>.addItems([<minecraft:beef>,<tfc:food/beef>]);
<ore:foodCookedbeef>.addItems([<minecraft:cooked_beef>,<tfc:food/cooked_beef>]);
