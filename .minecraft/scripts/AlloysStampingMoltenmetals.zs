...
for i, ah in axehead{
mods.embers.Stamper.add(ah,castingMetal[i]*144*ingots_axe, <tfc:ceramics/fired/mold/axe_head>,null);
}
...
mods.embers.Stamper.add(ph,castingMetal[i]*144*ingots_ProP, <tfc:ceramics/fired/mold/propick_head>,null);
}
...
mods.embers.Stamper.add(pah,castingMetal[i]*144*ingots_PH, <tfc:ceramics/fired/mold/pick_head>,null);
}
...
mods.embers.Stamper.add(sh,castingMetal[i]*144*ingots_SH, <tfc:ceramics/fired/mold/shovel_head>,null);
}
...
mods.embers.Stamper.add(<contenttweaker:gold_shovel_head>,<liquid:gold>*144*ingots_SH, <tfc:ceramics/fired/mold/shovel_head>,null);
mods.embers.Stamper.add(<contenttweaker:obsidian_shovel_head>,<liquid:lava>*144*ingots_SH, <tfc:ceramics/fired/mold/shovel_head>,<nuclearcraft:gem_dust:3>);
mods.embers.Stamper.add(<contenttweaker:manasteel_shovel_head>,<liquid:manasteel>*144*ingots_SH, <tfc:ceramics/fired/mold/shovel_head>,null);
mods.embers.Stamper.add(<contenttweaker:diamond_shovel_head>,<liquid:diamond>*144*ingots_SH, <tfc:ceramics/fired/mold/shovel_head>,<contenttweaker:manasteel_shovel_head>);
...
for i, hh in hoehead{
mods.embers.Stamper.add(hh,castingMetal[i]*144*ingots_HH, <tfc:ceramics/fired/mold/hoe_head>,null);
}
...
mods.embers.Stamper.add(ch,castingMetal[i]*144*ingots_CH, <tfc:ceramics/fired/mold/chisel_head>,null);
}
...
mods.embers.Stamper.add(mh,castingMetal[i]*144*ingots_MH, <tfc:ceramics/fired/mold/mace_head>,null);
}
...
mods.embers.Stamper.add(jh,castingMetal[i]*144*ingots_JH, <tfc:ceramics/fired/mold/javelin_head>,null);
}
...
mods.embers.Stamper.add(sob,castingMetal[i]*144*ingots_SoB, <tfc:ceramics/fired/mold/sword_blade>,null);
}
...
mods.embers.Stamper.add(sb,castingMetal[i]*144*ingots_SB, <tfc:ceramics/fired/mold/saw_blade>,null);
}
...
mods.embers.Stamper.add(kb,castingMetal[i]*144*ingots_KB, <tfc:ceramics/fired/mold/knife_blade>,null);
}
...
mods.embers.Stamper.add(syb,castingMetal[i]*144*ingots_SyB, <tfc:ceramics/fired/mold/scythe_blade>,null);
}
...
mods.embers.Stamper.add(HamH,castingMetal[i]*144*ingots_HamH, <tfc:ceramics/fired/mold/hammer_head>,null);
}
