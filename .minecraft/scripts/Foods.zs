...
registerFood(<foodexpansion:itembatwing>,1,0.5,0.2,3,0,0,0,1,0);	<ore:categoryMeat>.add(<foodexpansion:itembatwing>);      	registerItemHeat(<foodexpansion:itembatwing>,1,480,false);          #bat wing
registerFood(<foodexpansion:itemcookedbatwing>,1,1,0.6,2,0,0,0,1.5,0);	<ore:categoryCookedMeat>.add(<foodexpansion:itemcookedbatwing>);      	registerItemHeat(<foodexpansion:itemcookedbatwing>,1,180,false);          #cooked bat wingregisterFood(<foodexpansion:itemblazecream>,3,0.2,1.6,2,0.2,1,0,0.4,0.3);	<ore:categoryMeal>.add(<foodexpansion:itemblazecream>);      	          #blaze cream soup
