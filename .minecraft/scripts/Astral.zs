...
//StarMetal Crafting
mods.inspirations.Cauldron.addFluidRecipe(<astralsorcery:itemcraftingcomponent:1>, <ore:ingotPigIron>, <liquid:astralsorcery.liquidstarlight>, 2, true);
...
mods.terrafirmacraft.Barrel.addRecipe("Star_Dust", <tombstone:dust_of_vanishing>, <liquid:astralsorcery.liquidstarlight>*1000, <astralsorcery:itemcraftingcomponent:2>,12);
